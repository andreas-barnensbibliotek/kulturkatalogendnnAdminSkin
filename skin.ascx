...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><img src="http://dnndev.me/Portals/_default/Skins/kk_Admin_Acklay/img/kulturkatalogen/kulturkatalogMinilogo.png" /></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="http://dnndev.me/Portals/_default/Skins/kk_Admin_Acklay/img/kulturkatalogen/kulturkatalogen250.png" /></span>
    </a>
...
<!-- ################################################################################################ -->
  ...
  <div class="control-sidebar-bg"></div>
    <span id="kk_aj_CurrentUserid"><%= UserController.Instance.GetCurrentUserInfo().UserID%></span>
