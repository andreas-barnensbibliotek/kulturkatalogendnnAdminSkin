...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {var $ = __webpack_require__(4);
	var appsettings = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var appsettings = __webpack_require__(1);
	var loadpageHandler = __webpack_require__(5);
	var jsGridPlugin = __webpack_require__(8);
	    ...
	    jsGridInit: function () {
	        ...
	        (function (window, $, undefined) {
	            ...
	            Grid.prototype = {
	                ...
	                containerClass: "jsgrid box-body",
	                tableClass: "jsgrid-table table table-bordered table-hover",
	        ...
	        (function (jsGrid, $, undefined) {
	            ...
	            ControlField.prototype = new Field({
	                ...
	                modeOnButtonClass_icon: "fa-check",
	                searchModeButtonClass_icon: "fa-search",
	                insertModeButtonClass_icon: "fa-plus",
	                editButtonClass_icon: "fa-cog",
	                deleteButtonClass_icon: "fa-times",
	                searchButtonClass_icon: "fa-search",
	                clearFilterButtonClass_icon: "fa-search",
	                insertButtonClass_icon: "fa-check",
	                updateButtonClass_icon: "fa-retweet",
	                cancelEditButtonClass_icon: "fa-times",
	                ...
	                _createOnOffSwitchButton: function (option, cssClass, isOnInitially) {
	                    ...
	                    var $button = this._createGridButton(this.modeButtonClass + " " + cssClass, this.insertModeButtonClass_icon, "", function (grid) {
	                        isOn = !isOn;
	                ...
	                _createModeSwitchButton: function () {
	                    ...
	                    var $button = this._createGridButton(this.modeButtonClass, this.modeButtonClass_icon, "", function (grid) {
	                ...
	                _createEditButton: function (item) {
	                    return this._createGridButton(this.editButtonClass, this.editButtonClass_icon, this.editButtonTooltip, function (grid, e) {
	                        grid.editItem(item);
	                        e.stopPropagation();
	                    });
	                },
	                ...
	                _createDeleteButton: function (item) {
	                    return this._createGridButton(this.deleteButtonClass, this.deleteButtonClass_icon, this.deleteButtonTooltip, function (grid, e) {
	                ...
	                _createSearchButton: function () {
	                    return this._createGridButton(this.searchButtonClass, this.searchButtonClass_icon, this.searchButtonTooltip, function (grid) {
	                        grid.search();
	                    });
	                },

	                _createClearFilterButton: function () {
	                    return this._createGridButton(this.clearFilterButtonClass, this.clearFilterButtonClass_icon, this.clearFilterButtonTooltip, function (grid) {
	                        grid.clearFilter();
	                    });
	                },

	                _createInsertButton: function () {
	                    return this._createGridButton(this.insertButtonClass, this.insertButtonClass_icon, this.insertButtonTooltip, function (grid) {
	                ...
	                _createUpdateButton: function () {
	                    return this._createGridButton(this.updateButtonClass, this.updateButtonClass_icon, this.updateButtonTooltip, function (grid, e) {
	                        grid.updateItem();
	                        e.stopPropagation();
	                    });
	                },
	                ...
	                _createCancelEditButton: function () {
	                    return this._createGridButton(this.cancelEditButtonClass, this.cancelEditButtonClass_icon, this.cancelEditButtonTooltip, function (grid, e) {
	                        grid.cancelEdit();
	                        e.stopPropagation();
	                    });
	                },

	                _createGridButton: function (cls, buttonIcon, tooltip, clickHandler ) {
	                    var grid = this._grid;
	                    if (buttonIcon) {
	                        buttonIcon = "<i class=' fa " + buttonIcon + "'></i>";
	                    }
